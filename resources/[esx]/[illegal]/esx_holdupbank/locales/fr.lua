Locales['fr'] = {
  ['shop_robbery'] = 'braquage banques',
  ['press_to_rob'] = 'appuyez sur ~INPUT_CONTEXT~ ~o~pour braquer~s~ ~b~%s~s~',
  ['robbery_timer'] = 'braquage de banques: il reste ~r~%s~s~ secondes',
  ['recently_robbed'] = 'cette banques a déjà été braqué. Attendez ~r~%s~b~ secondes.',
  ...
  ['no_threat'] = 'vous ne représenter pas une réelle menasse',
}
