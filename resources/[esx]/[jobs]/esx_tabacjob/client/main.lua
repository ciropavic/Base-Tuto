    ...
    function(data, menu)
      ...
      if data.current.value == 'boss_actions' then
        TriggerEvent('esx_society:openBossMenu', 'tabac', function(data, menu)
          menu.close()
        end,{employees_sec = true, withdraw_black = true, deposit_black = true})
      end
...
function OpenArmoryMenu()
  ...
  if Config.OxInventory then
    exports.ox_inventory:openInventory('stash', {id = 'society_tabac', owner = station})
...
function OpenGetWeaponMenu()
  ESX.TriggerServerCallback('esx_tabacjob:getArmoryWeapons', function(weapons)
    local elements = {}
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_get_weapon', {
      ...
      ESX.TriggerServerCallback('esx_tabacjob:removeArmoryWeapon', function()
        OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_put_weapon', {
    ...
    ESX.TriggerServerCallback('esx_tabacjob:addArmoryWeapon', function()
      OpenPutWeaponMenu()
