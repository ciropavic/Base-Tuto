...
RegisterNetEvent('esx_tabacjob:getStockItem')
...
RegisterNetEvent('esx_tabacjob:putStockItems')
...
ESX.RegisterServerCallback('esx_tabacjob:getArmoryWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_tabacjob:addArmoryWeapon', function(source, cb, weaponName, removeWeapon)
  local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_tabacjob:removeArmoryWeapon', function(source, cb, weaponName)
  local xPlayer = ESX.GetPlayerFromId(source)
