Locales['fr'] = {
  ['show_active_character'] = 'montrer le Perso actif',
  ['active_character'] = 'Perso actif: ~b~%s~s~',
  ...
  ['deleted_character'] = 'perso supprimer.',
  ['error_delete_character'] = "There was a problem deleting your character.",
  ['thank_you_for_registering'] = "Visa validé, bonne chance sur youtube!",
