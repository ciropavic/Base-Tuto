Locales['fr'] = {
  ...
  ['deposit_society_black_money']  = 'déposer argent sale',
  ['withdraw_society_black_money'] = 'retirer argent sale',
  -- job2 
  ['leader_menu']              = 'leader',
  ['deposit_money']          = 'déposer argent',
  ['members']                = 'membres',
  ['members_list']           = 'liste des membres',
  ['members_management']     = 'gestion membres',
  ['bounty_amount']          = 'montant des primes',
  ['bounty_management']      = 'gestion primes',
  ['withdraw_money']         = 'retirer argent ',
  ['you_have_been_hired_job2']    = 'Vous avez été recruté dans %s',
  ['you_have_been_fired_job2']    = 'Vous avez été viré de %s',
  ['withdraw_black_money']         = 'retirer argent sale',
  ['deposit_black_money']          = 'déposer argent sale',
  --reserviste
  ['reserviste']               = 'réserviste',
  ['reserviste_list']          = 'liste des réserviste',
  ['reserviste_management']    = 'gestion réserviste',
}
